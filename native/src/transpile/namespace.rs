...
pub(super) fn group_lazy_imports_by_file(
...
pub(super) struct DynamicImportRewriteVisitor {
    importer_file_path: String,
    lazy_imports: HashMap<String, LazyImportInput>,
}

impl DynamicImportRewriteVisitor {
    pub(super) fn new(file_path: &Path, lazy_imports: &[LazyImportInput]) -> Self {
        Self {
...
pub(super) fn rewrite_bundler_runtime_namespace_usage(
    module: &mut Module,
    file_path: &Path,
