...
use self::exports::RuntimeBindingNames;
use self::import_plans::prepare_runtime_import_bindings;
use self::statements::emit_runtime_statements;
...
pub(crate) fn emit_bundler_runtime_module_text<'a>(
    ...
    emit_runtime_statements(
        ...
        &runtime_names,
        &local_export_modes,
        &import_bindings.binding_rewrites,
        &import_bindings.slot_aliases,
