 ...
 */
export function parseContents(commentText: string): null | ParsedJSDocComment {
...
export function toStringWithoutStartEnd(
  tags: Tag[],
...
export class MutableJSDoc {
  constructor(
    ...
    private sourceComment: null | ts.SynthesizedComment,
    public tags: Tag[],
  ) {}
...
function parseJSDoc(
  ...
  diagnostics?: ts.Diagnostic[],
  sourceFile?: ts.SourceFile,
): [Tag[], null | ts.SynthesizedComment] {
