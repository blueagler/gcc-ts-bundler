...
function propertyName(prop: ts.NamedDeclaration): null | string {
...
function containsOptionalChainingOperator(
  node: ts.CallExpression | ts.NonNullExpression | ts.PropertyAccessExpression,
): boolean {
...
export function jsdocTransformer(
  ...
  return (context: ts.TransformationContext): ts.Transformer<ts.SourceFile> => {
    return (sourceFile: ts.SourceFile) => {
       ...
       */
      let contextThisType: null | ts.Type = null;
      ...
      function visitTypeAliasDeclaration(
        ...
        let propertyBase: null | string = null;
        if (
