...
export async function createRuntimeExternFixture() {
  ...
  await fixture.write(
    ...
    [
      ...
      "    : (obj[key] = value);",
      "const __publicField2 = (obj, key, value) =>",
      ...
      "  constructor() {",
      '    __publicField2(this, "counts", new Map());',
      '    __publicField2(this, "current", new Map());',
      '    __publicField2(this, "previous", new Map());',
      '    __publicField2(this, "is_fork", false);',
      '    __publicField2(this, "id", 7);',
